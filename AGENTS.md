...
The active frontend is `frontend/putmeon-web`. Use its existing feature-oriented layered architecture. Read `ARCHITECTURE.md` before structural changes. Do not alternate between top-level pages/services and feature directories merely for naming preferences.
